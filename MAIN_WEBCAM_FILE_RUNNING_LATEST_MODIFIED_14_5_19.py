...
#	*		
#	*		RUNNING FILE COMMAND :: 	python MAIN_WEBCAM_FILE_RUNNING_LATEST_MODIFIED_14_5_19.py
#	*/
...
while True:
	...
	for output in layerOutputs:
		...
		for detection in output:
			...
			if confidence > args["confidence"]:
				...
				# the size of the image, keeping in mind that it
	...
	if len(idxs) > 0:
		...
		for i in idxs.flatten():
			...
			if(classIDs[i]==43):
				cv2.putText(frame, "Knife", (x, y - 5),cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 2)
				continue
			else:
